...
void CMyApp::InitCube()
{
	...
	//front									 
	vertices.push_back({ glm::vec3(-0.5, -0.5, +0.5), glm::vec2(0, 0.5) });
	vertices.push_back({ glm::vec3(+0.5, -0.5, +0.5), glm::vec2(0.333, 0.5) });
	vertices.push_back({ glm::vec3(-0.5, +0.5, +0.5), glm::vec2(0, 1) });
	vertices.push_back({ glm::vec3(+0.5, +0.5, +0.5), glm::vec2(0.333, 1) });
	//back
	vertices.push_back({ glm::vec3(+0.5, -0.5, -0.5), glm::vec2(0.666, 0.5) });
	vertices.push_back({ glm::vec3(-0.5, -0.5, -0.5), glm::vec2(1, 0.5) });
	vertices.push_back({ glm::vec3(+0.5, +0.5, -0.5), glm::vec2(0.666, 1) });
	...
	vertices.push_back({ glm::vec3(-0.5, -0.5, +0.5), glm::vec2(0.333, 0) });
	vertices.push_back({ glm::vec3(-0.5, +0.5, -0.5), glm::vec2(0, 0.5) });
	vertices.push_back({ glm::vec3(-0.5, +0.5, +0.5), glm::vec2(0.333, 0.5) });
	//top									 
	vertices.push_back({ glm::vec3(-0.5, +0.5, +0.5), glm::vec2(0.333, 0.5) });
	vertices.push_back({ glm::vec3(+0.5, +0.5, +0.5), glm::vec2(0.333, 0) });
	vertices.push_back({ glm::vec3(-0.5, +0.5, -0.5), glm::vec2(0.666, 0.5) });
	vertices.push_back({ glm::vec3(+0.5, +0.5, -0.5), glm::vec2(0.666, 0) });
	//bottom								 
...
{
	// fájlból betöltés
	m_loadedTextureID = TextureFromFile("dobokocka.jpg");
...
void CMyApp::Render()
{
	...
	//GL_TRIANGLES 3 csúcsponttal dolgozik, egy háromszöget jelenít meg belõlük
